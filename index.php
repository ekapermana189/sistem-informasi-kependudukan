	...
	<div class="wrapper">
					...
					if (isset($_GET['page'])) {
						...
						switch ($hal) {
							...
							case 'suket-pindah':
								...
								//Tanah
							case 'data-tanah':
								include "admin/tanah/data_tanah.php";
								break;
							case 'add-tanah':
								include "admin/tanah/add_tanah.php";
								break;
							case 'edit-tanah':
								include "admin/tanah/edit_tanah.php";
								break;
							case 'del-tanah':
								include "admin/tanah/del_tanah.php";
								break;
							case 'view-tanah':
								include "admin/tanah/view_tanah.php";
								break;
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Copyright &copy;
				<a target="_blank" href="https://www.youtube.com/channel/UC4EDCdgP_JT-8wDIkP-R2pA">
					<strong> Ahmad Rifaldi</strong>
				</a>
				All rights reserved.
			</div>
			<b>ahmad digital.id</b>
		</footer>
